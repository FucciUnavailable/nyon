...
Combines project updates, AI summary, optional GitHub stats, and email delivery.
"""
...
def generate(
    ...
    """
    Generate and send complete weekly engineering report with AI summary.
    
    Workflow:
    1. Load project updates from JSON
    2. Generate AI summary (optional)
    3. Render email with all sections
    4. Send via SendGrid (unless --dry-run)
    """
    try:
        # Load project report
